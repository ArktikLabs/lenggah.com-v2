...
const tabs = ["Our Expertise", "Expert Design Advice", "Product Guarantee", "White Glove Delivery"]
  ...
  return (
    <section className="bg-background">
      ...
      <div className="bg-brand-orange px-6 py-16 text-center md:py-20">
        <h2 className="font-display text-pretty text-3xl leading-tight text-white md:text-5xl">
      ...
      <div className="bg-brand-teal px-6 py-10 md:py-14">
        <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 md:grid-cols-4 md:gap-10">
          {features.map((f) => (
            <div key={f.label} className="flex flex-col items-center text-center">
              <f.icon className="h-10 w-10 text-white md:h-12 md:w-12" />
              <p className="mt-3 text-sm leading-snug text-white md:text-base">{f.label}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-background px-4 py-10 md:py-16">
        <div className="mx-auto w-full max-w-6xl">
          ...
          {/* Tabs */}
          <nav aria-label="Expertise tabs" className="mt-6">
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-[320px,1fr]">
            ...
            <div className="bg-brand-orange" style={{ minHeight: "400px" }} aria-hidden="true" />

            {/* Right: text column */}
            <div className="space-y-4">
              <h3 className="text-2xl font-medium text-brand-ink md:text-3xl">12 years of experience</h3>
              ...
              <a href="#" className="inline-block text-sm text-brand-ink/60 underline hover:text-brand-ink">
                See more
              </a>
            </div>
          </div>
